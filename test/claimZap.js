...
async function logBalances() {
  ...
  await ve3TokenRewardPool
    .balanceOf(userA)
    .then((a) => console.log("pool ve3Token: " + web3.utils.fromWei(a, "ether")));
  await ve3dRewardPool.balanceOf(userA).then((a) => console.log("pool veToken: " + web3.utils.fromWei(a, "ether")));
  await ve3TokenRewardPool
    .earned(userA)
    .then((a) => console.log("pool ve3Token earned: " + web3.utils.fromWei(a, "ether")));
...
contract("Test claim zap", async (accounts) => {
  ...
  it("deposit lpToken and veAsset, stake and get rewards", async () => {
    ...
    await lpToken.approve(booster.address, lpTokenBalance);
    await booster.deposit(0, lpTokenBalance, true);
    ...
    await zap.claimRewards(
      [lPRewardPool.address, ve3TokenRewardPool.address],
      [ve3TokenLockRewardPool.address],
      [],
      [],
      0,
      0,
